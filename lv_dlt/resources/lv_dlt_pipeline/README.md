...
This folder defines all source code for the 'lv_dlt_pipeline' pipeline:
...
* Take a look at the sample under "sample_trips_lv_dlt.sql" to get familiar with the syntax.
