...
# =========================================================
# 🔧 Fully Recursive Flattening (Structs + Nested Arrays)
# =========================================================
def fully_flatten(df: DataFrame) -> DataFrame:
        ...
        for field in df.schema.fields:
            ...
            if isinstance(dtype, StructType):
                ...
                for subfield in dtype.fields:
                    ...
                    col_name = f"{safe_name}_{sub_name}"
    ...
    # Cast all remaining columns to string to handle type drift
    for field in df.schema.fields:
...
@dlt.table(
    ...
    comment="Silver flattened events with fully nested arrays flattened",
...
def silver_events_patient_data():
    ...
    # Parse JSON with schema evolution
    ...
    # Fully flatten including nested arrays
    df_flat = fully_flatten(df_parsed)
    return df_flat
